const Tournaments = () => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4 bg-gray-800 p-10 rounded-md">
        <div className="pt-10">
          ...
          <h6 className="mb-2 font-semibold leading-5 text-indigo-600">
            30th Weekly ChesSBS Arena
          </h6>
